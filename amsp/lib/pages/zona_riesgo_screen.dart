...
class _ZonasRiesgoScreenState extends State<ZonasRiesgoScreen> {
  ...
  Future<void> cargarDatos() async {
    try {
      ...
      // Usamos la función para adaptar el código
      ...
      // Cuando ya tienes los datos, regresa a la pantalla anterior con los códigos
...
// Función para adaptar el código del INEGI a formato de 5 dígitos (2 para estado + 3 para municipio)
